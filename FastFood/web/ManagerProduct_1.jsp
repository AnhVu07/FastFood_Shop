                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <c:forEach items="${listA}" var="o">
                            <tr>
                                ...
                                <td>${o.isAdmin}</td>
                                <td>
                                    <a href="LoadAcc?aid=${o.uID}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="deleteAcc?aid=${o.uID}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
