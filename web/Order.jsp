                    ...
                    <form action="order" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <input value="Thanh toán khi nhận hàng" name="pay" type="text" class="form-control" readonly="" required>
                            </div>
                            <div class="form-group">
                                <label>Tổng tiền</label>
                                <input value="${total}00 đ" name="total" type="text" class="form-control" readonly="" required>
                            </div>
                        </div>
